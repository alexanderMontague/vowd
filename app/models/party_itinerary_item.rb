class PartyItineraryItem < ApplicationRecord
  include UuidPrimaryKey
  include WeddingScoped

  belongs_to :party_board, inverse_of: :itinerary_items
  ...
  scope :ordered, -> { order(Arel.sql("occurs_on IS NULL, occurs_on ASC"), :position, :created_at) }
